...
def scan_vote(file):
    ...
    img = cv2.adaptiveThreshold(img, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 17, 7)
    ...
    x1=int(y/3)
    # x1=int(x1/2)
    cropped = noisy_image[x-y1:x, x1:y]
    ...
    return Name,Middle_Name,Surname,Gender,bdate,voter_id